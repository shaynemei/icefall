...
class SeasaltAsrDataModule:
    ...
    def train_cuts(self) -> CutSet:
        logging.info(f"About to get train_combined cuts")
        path = self.args.manifest_dir / f"cuts_train_shuf.jsonl.gz"
        cuts_train = CutSet.from_jsonl_lazy(path)
        return cuts_train

    @lru_cache()
    def dev_cuts(self, path_cuts) -> CutSet:
